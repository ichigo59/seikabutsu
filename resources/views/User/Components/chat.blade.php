...
<div class="comment-container row justify-content-center">
    <div class="input-group comment-area">
        <textarea class="form-control" placeholder="input message" aria-label="With textarea"></textarea>
...
<form method="POST" action="{{route('add')}}">
    ...
    <div class="comment-container row justify-content-center">
        <div class="input-group comment-area">
            <textarea class="form-control" id="comment" name="comment" placeholder="input message"
    ...
    <div class="card-body chat-card">
        @foreach ($comment)
        @include('User.Components.comment', ['comment' => $comment])
        @endforeach
    </div>
